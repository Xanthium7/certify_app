...
export default function UploadCertificate({ onUpload, isProcessing }: UploadCertificateProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">Upload an image of a certificate to convert it to an editable SVG</p>
      </div>
